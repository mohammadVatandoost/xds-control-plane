...
import (
	...
	"github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshtrace/api/v1alpha1"
	v1alpha1_k8s "github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshtrace/k8s/v1alpha1"
