...
import (
	...
	api "github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshretry/api/v1alpha1"
	plugin_v1alpha1 "github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshretry/plugin/v1alpha1"
