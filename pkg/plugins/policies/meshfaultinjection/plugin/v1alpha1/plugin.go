...
import (
	...
	plugin_xds "github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshfaultinjection/plugin/xds"
...
func (p plugin) Apply(rs *core_xds.ResourceSet, ctx xds_context.Context, proxy *core_xds.Proxy) error {
	if proxy.Dataplane == nil {
		...
		// todo: add support for ExternalService and ZoneEgress, https://github.com/mohammadVatandoost/xds-conrol-plane/issues/5050
		return nil
	}
