...
import (
	...
	api "github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshproxypatch/api/v1alpha1"
	plugin "github.com/mohammadVatandoost/xds-conrol-plane/pkg/plugins/policies/meshproxypatch/plugin/v1alpha1"
