...
// NewPrometheusHook registers Prometheus collectors.
...
func (hook *PrometheusHook) BeforeProcess(ctx context.Context, cmd redis.Cmder) (context.Context, error) {
	return context.WithValue(ctx, startKey{}, time.Now()), nil
}

func (hook *PrometheusHook) AfterProcess(ctx context.Context, cmd redis.Cmder) error {
...
func (hook *PrometheusHook) BeforeProcessPipeline(ctx context.Context, cmds []redis.Cmder) (context.Context, error) {
	return context.WithValue(ctx, startKey{}, time.Now()), nil
}

func (hook *PrometheusHook) AfterProcessPipeline(ctx context.Context, cmds []redis.Cmder) error {
